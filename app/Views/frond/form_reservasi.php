          ...
          <div class="card-body">
            <form action="<?= base_url('reservasi'); ?>" method="post" autocomplete="off">
              ...
              <div class="form-group">
                ...
                <input type="date" class="form-control <?= session('errors.tanggal_reservasi') ? 'is-invalid' : '' ?>"
              ...
              <div class="form-group">
                ...
                <input type="time" class="form-control <?= session('errors.jam_selesai') ? 'is-invalid' : '' ?>"
                  id="jam_selesai" min="<?php echo date('H:i', strtotime('+1 minute')); ?>" name="jam_selesai" readonly>
                <div class="invalid-feedback">
                ...
                <div class="row">
                  <div class="col-5">
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="type_bayar" id="bayar_offline"
                        value="bayar offline" checked>
                  ...
                  <div class="col-5">
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="type_bayar" id="bayar_online"
                        value="bayar online">
...
<script>
  $(document).ready(function () {
    $('#tanggal_reservasi').on('change', function () {
      ...
      var formattedDateIndonesia = tanggal + '-' + ('0' + bulan).slice(-2) + '-' + ('' + tahun).slice();
        ...
        success: function (data) {
          ...
          if (data.treatments.length > 0) {
            $.each(data.treatments, function (index, data) {
              ...
              row.append("<td>" + moment(data.jam_mulai, "HH:mm").format("HH:mm") + "</td>");
              row.append("<td>" + moment(data.jam_selesai, "HH:mm").format("HH:mm") + "</td>");
    ...
    $("#jam_mulai").on("change", function () {
      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          var jamSelesai = moment(jamMulai, "HH:mm").add(durasi, "minutes").format("HH:mm");
          ...
          if (jamSelesaiMoment.isBefore(officeStart) || jamSelesaiMoment.isAfter(officeEnd)) {
            ...
            var errorElem = document.getElementById("jam_mulai_message");
            errorElem.innerHTML = "Jam Selesai harus berada dalam jam kantor (08:00 Wib - 17:30 Wib)";
